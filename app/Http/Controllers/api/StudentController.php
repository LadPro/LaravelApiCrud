...
class StudentController extends Controller
{
    ...
    public function store(StoreStudentRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return ApiResponseHelper::sendResponse(new StudentResource($student, 'Record create successfully', 201));
        }
        catch(\Exception $ex) {
            DB::rollBack();
    ...
    public function update(UpdateStudentRequest $request, string $id)
    {
        ...
        try {
            ...
            DB::commit();   
            return ApiResponseHelper::sendResponse(new StudentResource(null, 'Record updated successfully', 200));
        }
        catch(\Exception $ex) {
            DB::rollBack();
            return ApiResponseHelper::rollback($ex);
    ...
    public function destroy(string $id)
    {
        ...
        return ApiResponseHelper::sendResponse(null, 'Record deleted successfully', 200);
    }
}
